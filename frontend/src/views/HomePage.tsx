        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="h-[300px]">
              ...
              ) : aggChartData.length === 0 || aggChartData.every(d => d.value === 0) ? (
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="h-[300px]">
            ...
            ) : timeSeriesChartData.length === 0 || sortedEngineers.every(eng => timeSeriesChartData.every(row => (row[eng.id] as number) === 0)) ? (
              <div className="flex flex-col items-center justify-center h-full text-muted-foreground">
                <BarChart3 className="h-12 w-12 mb-2 opacity-20" />
                <p>No data for this period</p>
              </div>
